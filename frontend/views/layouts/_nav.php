                ...
                <ul class="nav navbar-nav navbar-right pull-right">
                    <li class="dropdown hidden-xs">
                        ...
                        <ul class="dropdown-menu dropdown-menu-lg">
                            <li class="notifi-title"><span class="label label-default pull-right">Новые: 0</span>Уведомления</li>
...
<!--                <li class="text-muted menu-title">Navigation</li>-->
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect waves-light"><i class="ti-bar-chart"></i><span class="label label-pink pull-right">11</span><span> Charts </span></a>
                    <ul class="list-unstyled">
                ...
                <li class="has_sub">
                    <a href="#" class="waves-effect waves-light active"><i class="ti-crown"></i><span class="label label-success pull-right">3</span><span> Apps </span></a>
                    <ul class="list-unstyled">
                        <li><a href="apps-inbox.html"> Email</a></li>
                        <li class="active"><a href="apps-calendar.html"> Calendar</a></li>
